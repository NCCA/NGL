...
namespace ngl
{
  ...
  void pyInitMat4(py::module & m)
  {
    py::class_<Mat4>(m, "Mat4")
        ...
        .def_static("rotateX",&Mat4::rotateX)
        .def_static("rotateY",&Mat4::rotateY)
        .def_static("rotateZ",&Mat4::rotateZ)
        ...
        .def("adjacent",py::overload_cast<>(&Mat4::adjacent))
        .def("adjacent",py::overload_cast<const Mat4 &>(&Mat4::adjacent))
