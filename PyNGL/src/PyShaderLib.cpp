...
namespace ngl
{
  void pyInitShaderLib(py::module & m)
  {
    py::class_<ShaderLib, std::unique_ptr<ShaderLib, py::nodelete>>(m, "ShaderLib")
        ...
        .def("loadShader",(bool (ShaderLib::*)(const std::string_view &,const std::string_view &,const std::string_view &,const std::string_view &,bool )) &ShaderLib::loadShader)
        .def("loadShader",(bool (ShaderLib::*)(const std::string_view &,const std::string_view &,const std::string_view &,bool )) &ShaderLib::loadShader)
