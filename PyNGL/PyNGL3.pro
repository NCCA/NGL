...
TARGET = $$BASE_DIR/lib/pyngl3.so
# this is where we want to put the intermediate build files ( ../obj3) so they don't clash with pyngl
OBJECTS_DIR = $$BASE_DIR/PyNGL/obj3
