...
#     program = ShaderProgram("test_program")
#     vert_shader = Shader(VERTEX_SHADER, gl.GL_VERTEX_SHADER)
#     frag_shader = Shader(FRAGMENT_SHADER, gl.GL_FRAGMENT_SHADER)
...
#     program = ShaderProgram("test_program")
#     vert_shader = Shader(VERTEX_SHADER, gl.GL_VERTEX_SHADER, compile_success=False)
#     program.attach_shader(vert_shader)
