...
TEST(Mat3, Mat3xReal)
{
  ...
  for(int y = 0; y < 3; ++y)
    for(int x = 0; x < 3; ++x)
      test.m_m[x][y] = value++;
  test = test * 4.2f;
  ngl::Mat3 result(0.0f, 12.599999427795f, 25.199998855591f, 4.199999809265f, 16.799999237061f, 29.399997711182f, 8.399999618530f, 21.000000000000f, 33.599998474121f);
