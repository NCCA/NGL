...
IF EXIST %HOME%\vcpkg (
  ...
  .\vcpkg install  gtest:x64-windows glm:x64-windows glfw3:x64-windows openimageio:x64-windows rapidjson:x64-windows rapidxml:x64-windows fmt:x64-windows freetype:x64-windows
