...
//----------------------------------------------------------------------------------------------------------------------
bool NCCABinMesh::load(std::string_view _fname, CalcBB _calcBB) noexcept
{
...
//----------------------------------------------------------------------------------------------------------------------
NCCABinMesh::NCCABinMesh(std::string_view _fname) noexcept
  : AbstractMesh()
{
  load(_fname);
}
...
//----------------------------------------------------------------------------------------------------------------------
NCCABinMesh::NCCABinMesh(std::string_view _fname, std::string_view _texName) noexcept
  : AbstractMesh()
{
  load(_fname);
  // load texture
...
//----------------------------------------------------------------------------------------------------------------------
void NCCABinMesh::save(std::string_view _fname) noexcept
{
