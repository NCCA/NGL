...
{
  return +m_00 * (m_11 * m_22 - m_21 * m_12) - m_01 * (m_10 * m_22 - m_12 * m_20) + m_02 * (m_10 * m_21 - m_11 * m_20);
}
...
Mat3 Mat3::inverse() noexcept
{
  ...
  if(det == 0.0f)
  {
    NGLMessage::addWarning("ngl 0 determinant in Mat3 returning identity matrix");
    return Mat3();
  }
  Real invdet = 1 / det;
