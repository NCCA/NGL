...
public :
  ...
  //----------------------------------------------------------------------------------------------------------------------
  inline Colour( Real _r=0.0, Real _g=0.0,  Real _b=0.0, Real _a=1.0 ) :
                 m_r(_r),
                 m_g(_g),
                 m_b(_b),
                 m_a(_a){;}
  ...
  //----------------------------------------------------------------------------------------------------------------------
  inline void set( Real _r,Real _g, Real _b, Real _a=1.0)
              {
                 m_r=_r;
                 m_g=_g;
                 m_b=_b;
  ...
  //----------------------------------------------------------------------------------------------------------------------
  inline void set( const Colour& _c )
              {
                m_r = _c.m_r;
                m_g = _c.m_g;
                m_b= _c.m_b;
