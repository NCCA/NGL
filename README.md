...
[![linux](https://github.com/NCCA/NGL/actions/workflows/linux.yml/badge.svg?branch=main)](https://github.com/NCCA/NGL/actions/workflows/linux.yml)[![BuildNGL](https://github.com/NCCA/NGL/actions/workflows/mac.yml/badge.svg)](https://github.com/NCCA/NGL/actions/workflows/mac.yml)[![BuildNGL](https://github.com/NCCA/NGL/actions/workflows/windows.yml/badge.svg)](https://github.com/NCCA/NGL/actions/workflows/windows.yml)[![CircleCI](https://circleci.com/gh/NCCA/NGL.svg?style=svg)](https://circleci.com/gh/NCCA/NGL)
[Circle CI](https://circleci.com/gh/NCCA)

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=sqale_index)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=coverage)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=NCCA_NGL&metric=bugs)](https://sonarcloud.io/summary/new_code?id=NCCA_NGL)
